...
BOT_TOKEN = "8770377683:AAHWIbyGGCfh23LMC9Lk90bfTfEd8hRv9B0" 
...
async def send_batch_files(update: Update, context: ContextTypes.DEFAULT_TYPE, batch_id: str):
    ...
    if not files:
        await context.bot.send_message(user_id, "🚫 <b>ᴇʀʀᴏʀ:</b> ꜰɪʟᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ.", parse_mode=ParseMode.HTML)
        return
